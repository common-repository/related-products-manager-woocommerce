...
class ProWC_Related_Products_Manager_Settings_General extends ProWC_Related_Products_Manager_Settings_Section {
	...
	function maybe_delete_product_transients() {
		if ( isset( $_GET['prowc_clear_all_products_transients'] ) && isset( $_GET['prowc_rpmnonce'] ) && wp_verify_nonce( $_GET['prowc_rpmnonce'], 'prowc_clear_transients_action' ) ) {
	...
	function get_settings() {
		...
		$settings = array(
			array(
				...
				'desc'     => sprintf(
					...
					wp_nonce_url( add_query_arg( 'prowc_clear_all_products_transients', 'yes' ), 'prowc_clear_transients_action', 'prowc_rpmnonce' )
				),
		...
		$settings = array_merge( $settings, array(
			...
			array(
				'desc'     => sprintf( 
					/* translators: %s is a placeholder for the attribute name */
					__( 'Attribute name, e.g.: %s', 'related-products-manager-woocommerce' ), '<code>color</code>' ),
			...
			array(
				'desc'     => sprintf( 
					 /* translators: %s is a placeholder for the attribute value */
					__( 'Attribute value, e.g.: %s', 'related-products-manager-woocommerce' ), '<code>Red</code>' ),
				'desc_tip' => apply_filters( 'prowc_related_products_manager', __( 'Required.', 'related-products-manager-woocommerce' ) . ' ' .
			...
			array(
				...
				'desc'     => __( 'Enable', 'related-products-manager-woocommerce' ),
				'desc_tip' => sprintf(
						/* translators: Explanation about the metabox and related products feature */
						__( 'This will add a metabox to each product\'s edit page. You will be able to select related products, product categories, and/or tags manually for each product individually. There is also an option to remove related products on a per-product basis.', 'related-products-manager-woocommerce' )
					) . ' ' . sprintf(
						/* translators: Explanation about the premium version plugin requirement */
						__( 'You will need %s plugin to relate products on a per-product basis.', 'related-products-manager-woocommerce' ),
						'<a target="_blank" href="https://prowcplugins.com/downloads/related-products-manager-for-woocommerce/?utm_source=related-products-manager-for-woocommerce&utm_medium=referral&utm_campaign=settings">Related Products Manager for WooCommerce Pro</a>'
					),
			...
			array(
				...
				'desc'     => __( 'Enable section', 'related-products-manager-woocommerce' ),
				'desc_tip' => apply_filters( 'prowc_related_products_manager', sprintf( 
					/* translators: Explanation about the premium version plugin requirement */
					__( 'You will need <a target="_blank" href="%s">Related Products Manager for WooCommerce Pro</a> plugin to enable this section.', 'related-products-manager-woocommerce' ),
			...
			array(
				...
				'desc' => '<details><summary>' . __( 'Default priorities', 'related-products-manager-woocommerce' ) . '</summary>' .
					'<p>' . sprintf(
						/* translators: Placeholder is for the action/hook name and priority */
						__( 'Before single product: %s', 'related-products-manager-woocommerce' ),
						'<code>' . implode( '</code>, <code>', array( 'wc_print_notices - 10' ) ) . '</code>'
					) . '</p>' .
					'<p>' . sprintf(
						/* translators: Placeholder is for the action/hook names and priorities */
						__( 'Before single product summary: %s', 'related-products-manager-woocommerce' ),
						'<code>' . implode( '</code>, <code>', array( 'woocommerce_show_product_sale_flash - 10', 'woocommerce_show_product_images - 20' ) ) . '</code>'
					) . '</p>' .
					'<p>' . sprintf(
						/* translators: Placeholder is for the action/hook names and priorities */
						__( 'Inside single product summary: %s', 'related-products-manager-woocommerce' ),
						'<code>' . implode( '</code>, <code>', array( 'woocommerce_template_single_title - 5', 'woocommerce_template_single_rating - 10', 'woocommerce_template_single_price - 10', 'woocommerce_template_single_excerpt - 20', 'woocommerce_template_single_add_to_cart - 30', 'woocommerce_template_single_meta - 40', 'woocommerce_template_single_sharing - 50' ) ) . '</code>'
					) . '</p>' .
					'<p>' . sprintf(
						/* translators: Placeholder is for the action/hook names and priorities */
						__( 'After single product summary: %s', 'related-products-manager-woocommerce' ),
						'<code>' . implode( '</code>, <code>', array( 'woocommerce_output_product_data_tabs - 10', 'woocommerce_upsell_display - 15', 'woocommerce_output_related_products - 20' ) ) . '</code>'
					) . '</p>' .
				'</details>',
			),
			array(
			...
			array(
				...
				'desc'     => __( 'Enable section', 'related-products-manager-woocommerce' ),
				'desc_tip' => apply_filters( 'prowc_related_products_manager', sprintf( 
					/* translators: Placeholder is for the plugin URL */
					__( 'You will need <a target="_blank" href="%s">Related Products Manager for WooCommerce Pro</a> plugin to enable this section.', 'related-products-manager-woocommerce' ),
					'https://prowcplugins.com/downloads/related-products-manager-for-woocommerce/?utm_source=related-products-manager-for-woocommerce&utm_medium=referral&utm_campaign=settings' ), 'settings' ),
			...
			array(
				'title'    => __( 'Title', 'related-products-manager-woocommerce' ),
				'desc'     => sprintf(
					 	/* translators: Example of shortcode usage for translations */
						__( 'You can use shortcodes here, for example: %s', 'related-products-manager-woocommerce' ),
					'<br>' . sprintf( 
						/* translators: Example of shortcode usage for category / tag / taxonomy titles */
						__( 'For category / tag / taxonomy titles, e.g.: %s.', 'related-products-manager-woocommerce' ),
						'<code>More from [prowc_rpm_product_category]</code>' ) .
					'<br>' . sprintf( 
						/* translators: Example of shortcode usage for translations */
						__( 'For translations, e.g.: %s.', 'related-products-manager-woocommerce' ),
